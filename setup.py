...
def read_description() -> str:
    ...
    try:
        ...
        With a focus on user-friendliness and efficiency, OPR aims to bridge the gap between biological research and computational tools,
        making primer-related workflows faster and more reliable.'''
...
setup(
    ...
    download_url='https://github.com/openscilab/opr/tarball/v0.6',
