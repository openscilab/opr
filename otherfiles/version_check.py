...
SETUP_ITEMS = [
    "version='{0}'",
    'https://github.com/openscilab/opr/tarball/v{0}']
README_ITEMS = [
    "[Version {0}](https://github.com/openscilab/opr/archive/v{0}.zip)",
    "pip install opr=={0}"]
CHANGELOG_ITEMS = [
    "## [{0}]",
    "https://github.com/openscilab/opr/compare/v{0}...dev",
    "[{0}]:"]
    ...
    for file_name in FILES:
        try:
            ...
            for test_item in FILES[file_name]:
                if file_content.find(test_item.format(OPR_VERSION)) == -1:
