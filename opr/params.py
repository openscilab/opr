...
PRIMER_SEQUENCE_LENGTH_WARNING = "The recommended range for primer length is between {0} and {1}.".format(PRIMER_LOWER_LENGTH, PRIMER_HIGHEST_LENGTH)
PRIMER_SEQUENCE_VALID_BASES_ERROR = "Primer sequence should only contain the nucleotide bases A, T, C, and G."
PRIMER_SEQUENCE_VALID_GC_CONTENT_RANGE_WARNING = "The recommended range for GC content is between {0}% and {1}%.".format(PRIMER_LOWEST_GC_RANGE * 100, PRIMER_HIGHEST_GC_RANGE * 100)
